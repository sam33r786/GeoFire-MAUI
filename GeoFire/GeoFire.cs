...
namespace GeoFire
{
    ...
    public class GeoFire
    {
        ...
        {
            return _collectionRef.Document(key);
        }
        ...
        public Task SetLocationAsync(string path, GeoPoint point) {
            ...
            return keyRef.SetAsync(data, true);
        }
        ...
        {
            var keyRef = GetDocumentRef(key);
            return GetLocationValue(await keyRef.GetAsync());
        }
